    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #ECEEF1;">
        ...
        <tr><td style="padding:32px 28px 8px;">
          <h1 style="margin:0 0 6px;font-size:23px;line-height:1.25;letter-spacing:-.02em;color:#0E0F12;">Confirm your email</h1>
          <p style="margin:0;font-size:15px;line-height:1.6;color:#6B7280;">Welcome, {{ $name }}! Please confirm this is your email so you can receive download alerts and recover your account. This link expires in 24 hours.</p>
        </td></tr>
        <tr><td style="padding:24px 28px 8px;">
          <a href="{{ $link }}" style="display:inline-block;background:#C6FF3D;color:#0E0F12;font-size:15px;font-weight:700;text-decoration:none;padding:13px 26px;border-radius:999px;">Confirm email</a>
        </td></tr>
        <tr><td style="padding:16px 28px 32px;">
          <p style="margin:0;font-size:12px;line-height:1.6;color:#9AA1AC;">If you didn’t create a Beam account, you can ignore this email.</p>
        </td></tr>
      </table>
